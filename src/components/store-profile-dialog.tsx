...
import { getManagedRestaurant, type GetManagerRestaurantResponse } from '@/api/get-manager-restaurant';
    ...
    return (
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>Atualize as informações do seu estabelicimento visíveis ao seu cliente
                </DialogDescription>
            </DialogHeader>
